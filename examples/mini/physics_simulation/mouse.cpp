...
PhysicsMouse::PhysicsMouse(LTEngine::Physics::PhysicsEngine *physics, LTEngine::Window *window) : m_physicsEngine(physics), m_window(window) {
    m_physicsBody = physics->addBody((LTEngine::Shapes::Circle){{0, 0}, (f32)CIRCLE_RADIUS}, LTEngine::Physics::PhysicsEngine::BodyType::BODY_TYPE_STATIC);
}
