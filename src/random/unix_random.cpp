...
UnixRandom::UnixRandom(u32 bufferSize) {
    m_bufferSize = bufferSize;

    m_urandom.open("/dev/urandom", std::ios::in | std::ios::binary);
    if (!m_urandom.is_open()) {
...
u64 UnixRandom::next_u64() {
    ...
    u64 value = m_buffer.back() | m_buffer.back() | m_buffer.back() | m_buffer.back() | m_buffer.back() | m_buffer.back() | m_buffer.back() | m_buffer.back();
