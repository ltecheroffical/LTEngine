#ifndef _LTCORE_OBJECT_STRUCTURE_HPP_
#define _LTCORE_OBJECT_STRUCTURE_HPP_
...
namespace LTCore::Object {
	class LTCORE_API ObjectStructure : public EngineStructure {
	public:
		class Object;
