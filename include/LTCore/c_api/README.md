...
Because namespaces are non existant in C, they aren't used. All objects are named this way `LTCore_{Actual Object Name}`. Functions are named like `LTCore_{Object name}_{Function Name}`. Examples are easily found within the codebase.