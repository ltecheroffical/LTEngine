#ifndef _LTCORE_COLOR_HPP_
#define _LTCORE_COLOR_HPP_


#include <LTCore/common/compiler_utils.h>


namespace LTCore::Graphics {
	LTCORE_PACK_START() struct Color {
		u8 r, g, b;
	...
	LTCORE_PACK_START() struct ColorA {
		u8 r, g, b, a;
