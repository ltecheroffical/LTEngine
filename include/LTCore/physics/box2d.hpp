#if !_LTCORE_BOX2D_PHYSICS_ENGINE_HPP_ && LTCORE_COMPONENT_PHYSICS_BOX2D
#define _LTCORE_BOX2D_PHYSICS_ENGINE_HPP_

#include <unordered_map>

#include <box2d/box2d.h>

#include <LTCore/physics/physics_engine_2d.hpp>


namespace LTCore::Physics {
	class LTCORE_API Box2D : public PhysicsEngine2D {
	public:
		Box2D();
		~Box2D();
