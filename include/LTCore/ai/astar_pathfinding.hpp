#ifndef _LTCORE_ASTAR_PATHFINDING_HPP_
#define _LTCORE_ASTAR_PATHFINDING_HPP_

#include <functional>

#include <LTCore/ai/pathfinding_2d.hpp>


namespace LTCore::AI {
	class LTCORE_API AStarPathfinding : public Pathfinding2D {
	public:
		AStarPathfinding();
